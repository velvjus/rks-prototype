<template>
  <nav aria-label="Setup Wizard Progress" class="w-full bg-transparent pt-4 sm:pt-5 pb-4 sm:pb-5 px-6 shrink-0">
...
const subtitles: Record<number, string> = {
  1: 'Setup overview & pending checklist',
  2: 'Invite colleagues & assign roles',
  3: 'Connect WhatsApp Business channel',
  4: 'Configure website LiveChat widget',
};
